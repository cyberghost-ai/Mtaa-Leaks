...
const mockPosts: Post[] = [
  ...
  },
  {
    ...
    coverImage: {
      url: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=800&auto=format&fit=crop',
      alt: 'People dancing',
      width: 800,
      height: 600
    },
      ...
      <div className="mt-16 py-12 bg-gradient-to-r from-primary/10 via-secondary/5 to-primary/10 border-y border-white/10">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-3 rounded-xl bg-gradient-to-r from-primary to-secondary text-black font-bold hover:shadow-xl hover:shadow-primary/30 transition-all">
              Submit Anonymous Tip
            </button>
            <button className="px-8 py-3 rounded-xl glass-morphism border border-white/10 hover:border-primary/30 transition-all">
